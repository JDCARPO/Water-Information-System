    ...
    <div class="container-fluid p-0">
      <div class="row no-gutters">
        ...
        <div class="col-lg-6 order-lg-1 my-auto showcase-text">
          <h2>Production</h2>
          <p class="lead mb-0"><strong>When you use a theme created by Start Bootstrap, you know that the theme will look great on any device, whether it's a phone, tablet, or desktop the page will behave responsively!</strong></p>
        </div>
      </div><br><br><br><br>
      <div class="row no-gutters">
      ...
      <div class="row no-gutters"><br><br>
