<?php
  ...
  $price = $_GET['price'];
    ...
    $result = "INSERT INTO `sales_product` (id, `product_id`, `quantity`,`unit`, `price`) VALUES ($id, '$product_id', '$quantity', '$unit','$price')";
        ...
        <br>
         <div class= "col-md-6">
    			<form class="myform" method="post">
				    ...
				    <a href ="#"><input class="btn" type="button" id="read_btn" value="Read"/><br></a>
          </form>
  			</form>     
        </td>
      </table>
